...
public class Thread {
    public static void initialize(boolean isClient, Function<String, Boolean> isModLoaded, Path configDir, Function<Boolean, NetworkWrapper> networkWrapperFunction) {
        ...
        CommonMain.initialize(isClient, (handlerType, factory) -> {
                ...
                ConfigWrapperImpl::new, networkWrapperFunction.apply(isModLoaded.apply("flan")));
