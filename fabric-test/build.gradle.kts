...
dependencies {
    ...
    modRuntimeOnly(group = "me.shedaniel", name = "RoughlyEnoughItems", version = properties["rei_version"] as String, dependencyConfiguration = excludeFabric)
    ...
    modRuntimeOnly(group = "io.github.flemmli97", name = "flan", version = "1.16.5-${properties["flan_version"]}", classifier = "fabric") {
        also(excludeFabric)
        isTransitive = false
    }
}
