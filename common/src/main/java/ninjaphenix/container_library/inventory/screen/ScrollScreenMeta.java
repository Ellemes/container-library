...
public final class ScrollScreenMeta extends ScreenMeta {
    public final int blankSlots, totalRows;

    public ScrollScreenMeta(int width, int height, int totalSlots, ResourceLocation texture, int textureWidth, int textureHeight) {
