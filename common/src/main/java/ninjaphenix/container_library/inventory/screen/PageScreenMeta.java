...
public final class PageScreenMeta extends ScreenMeta {
    public final int blankSlots, pages;

    public PageScreenMeta(int width, int height, int pages, int totalSlots, ResourceLocation texture, int textureWidth, int textureHeight) {
